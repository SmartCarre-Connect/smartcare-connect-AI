...
const cards = [
  { title: "Today's Duty", description: 'View your current ward assignment and schedule.', icon: ClipboardList },
  { title: 'Current Department', description: 'See the unit you are assigned to for the day.', icon: Building2 },
  { title: 'Supervisor', description: 'Contact your assigned supervising doctor.', icon: UserCircle2 },
  { title: 'Ward Rotation', description: 'Stay aligned with ward activities and patient rounds.', icon: BedDouble },
  { title: "Today's Patients", description: 'Monitor the patients assigned to your rotation.', icon: Users },
  { title: 'Attendance Status', description: 'Track current check-in and shift compliance.', icon: CheckCircle2 },
  { title: 'Working Hours', description: 'Monitor active and completed hours.', icon: Clock3 },
  { title: 'Announcements', description: 'Read updates shared by the department or HR.', icon: Megaphone },
  { title: 'Leave Request', description: 'Request time-off or emergency leave quickly.', icon: FileText },
  { title: 'Performance', description: 'Review progress and evaluation milestones.', icon: TrendingUp },
  { title: 'Notifications', description: 'Receive duty and attendance alerts.', icon: BellRing },
  { title: 'Settings', description: 'Update preferences and contact details.', icon: Settings },
];
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <GlassCard className="!p-6">
          ...
          <div className="mt-4 space-y-3">
            <button className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-left text-sm font-semibold text-slate-700">Mark Attendance</button>
            <button className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-left text-sm font-semibold text-slate-700">Submit Leave Request</button>
            <button className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-left text-sm font-semibold text-slate-700">View Feedback</button>
          </div>
        </GlassCard>
      </div>
    </div>
